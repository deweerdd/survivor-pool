...
- [ ] **1.2 — Tailwind theme & color palette**
      Create a custom Tailwind theme with Survivor-inspired colors: jungle greens, earth browns, torch oranges, sand neutrals, dark charcoal backgrounds. Define semantic color tokens (primary, secondary, accent, surface, muted). Update `app/globals.css` or Tailwind config.
      **Done when:** custom theme colors are available as Tailwind classes project-wide.
...
- [ ] **1.4 — NavBar redesign (`components/NavBar.tsx`)**
...
- [ ] **1.7 — Dashboard page redesign (`app/dashboard/page.tsx`)**
...
- [ ] **1.8 — Pools page redesign (`app/dashboard/pools/page.tsx`)**
...
- [ ] **1.9 — Leaderboard page redesign (`app/dashboard/pools/[poolId]/page.tsx`)**
...
- [ ] **1.10 — Allocation page redesign (`app/dashboard/pools/[poolId]/allocate/page.tsx`)**
...
- [ ] **1.11 — Loading & error state theming**
